...
Studio identity on the homepage (`#studio`), with every field coming from one content document that a later CMS can replace. `/studio` redirects to that section.
